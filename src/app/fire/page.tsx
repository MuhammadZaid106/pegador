  ...
  return (
    <main className="min-h-screen bg-white flex flex-col justify-between">
      <div>
        <AnouncementBar />
        <Header />
        <div className="relative w-full h-[50vh] sm:h-[65vh] bg-[#f4f4f4] overflow-hidden mt-12 sm:mt-16">
          <Image
        ...
        <section className="py-16 sm:py-24 px-6 sm:px-12 max-w-[1000px] mx-auto text-center space-y-6">
          ...
          <h2 className="text-[22px] sm:text-[30px] font-normal tracking-wide text-black uppercase leading-tight">
            PEGADOR is more than apparel. It is an urban statement.
          </h2>
          <p className="text-[13px] sm:text-[15px] text-neutral-500 font-light leading-relaxed max-w-[800px] mx-auto">
        ...
        <section className="bg-neutral-50 py-16 sm:py-24 px-6 sm:px-12">
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 sm:gap-16">
              <div className="space-y-3.5">
                <span className="text-[12px] font-bold tracking-wider text-[#111] uppercase block">
              ...
              <div className="space-y-3.5">
                <span className="text-[12px] font-bold tracking-wider text-[#111] uppecase block">
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-8 max-w-screen-2xl mx-auto w-full">
          <div className="text-center mb-10 sm:mb-16">
            <h3 className="text-[16px] sm:text-[20px] font-normal tracking-[0.18em] uppecase text-black">
              Campaign Lookbooks
            </h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="relative w-full aspect-[4/5] bg-[#f4f4f4] overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-black/20 flex items-end p-6">
                <span className="text-white text-[12px] font-bold tracking-widest uppecase">
                  City Ease
                </span>
              </div>
            </div>
            ...
            <div className="relative w-full inherit aspect-[4/5] bg-[#f4f4f4] overflow-hidden group sm:col-span-2 lg:col-span-1">
              <Image
                src="https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?auto=format&fit=crop&w=800&q=80"
                alt="Campaign looks 3"
                fill
                sizes="(max-width: 768px) 100vw, 33vw"
                className="object-cover transition-transorm duration-500 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-black/20 flex items-end p-6">
                <span className="text-white text-[12px] font-bold tracking-widest uppercase">
                  Minimal Essentials
