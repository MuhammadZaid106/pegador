...
export default function EssentialsPage() {
  // Filter 12 Essentials products
  const essentialsProducts = productsData
    .filter((p) => p.category === "ESSENTIALS")
    .slice(0, 12);
        ...
        <section className="pt-24 sm:pt-32 pb-16 px-4 sm:px-8 md:px-12 max-w-screen-2xl mx-auto w-full">
          ...
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-[11px] sm:text-[13px] text-neutral-500 font-light mt-1">
              Timeless luxury streetwear core basics designed for everyday wear
            </p>
          </div>
