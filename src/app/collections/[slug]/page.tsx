...
import { SlidersHorizontal, Grid2X2, Grid3X3, ChevronDown, Check } from "lucide-react";
...
export default function CollectionDetailPage({ params }: PageProps) {
  ...
  const totalActiveFilters = selectedSizes.length + selectedColors.length + (inStockOnly ? 1 : 0);
      ...
      <section className="pt-24 sm:pt-32 pb-12 px-4 sm:px-8 md:px-12 max-w-[1920px] mx-auto w-full">
          ...
          {filteredProducts.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-[14px] text-neutral-500 mb-4">No products match your selected filters.</p>
              <button
