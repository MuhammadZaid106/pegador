        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-center">
          ...
          <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left h-full space-y-6 md:space-y-8 md:pr-4">
            <div className="space-y-4">
              <span className="block text-[11px] font-medium tracking-[0.25em] text-[#888] uppercase mx-auto md:mx-0">
                NO RUSH. JUST PRESENCE.
              </span>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-[#111] leading-none uppercase">
                HERE AND NOW
              </h2>
            </div>

            <p className="text-[13px] text-[#444] leading-relaxed font-normal max-w-md md:max-w-none">
