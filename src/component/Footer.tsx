        ...
        <div className="hidden md:grid md:grid-cols-4 md:gap-y-0">
          ...
          <div className="md:pr-8 space-y-6">
            ...
            <ul className="space-y-3.5">
              <li>
                <Link href="/shipping" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  Shipping and delivery times
                </Link>
              </li>
              <li>
                <Link href="/return" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  Return
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  contact
                </Link>
              </li>
              <li>
          ...
          <div className="md:px-8 space-y-6">
            ...
            <ul className="space-y-3.5">
              <li>
                <Link href="/loyalty" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  Loyalty
                </Link>
              </li>
              <li>
                <Link href="/app" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  PEGADOR® App
                </Link>
              </li>
              <li>
                <Link href="/career" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  career
                </Link>
              </li>
              <li>
                <Link href="/reviews" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  Reviews
                </Link>
              </li>
            </ul>
          ...
          <div className="md:px-8 space-y-6">
            ...
            <ul className="space-y-3.5">
              <li>
                <Link href="/imprint" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  imprint
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  Privacy Policy
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/terms" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
              ...
              <li>
                <Link href="/cookies" className="text-[12px] text-white hover:underline underline-offset-4 decoration-2.2">
                  Cookie settings
                </Link>
              </li>
            </ul>
