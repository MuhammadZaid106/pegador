  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] px-4 py-20 text-center">
      ...
      <div className="relative flex items-center justify-center mb-8">
        <span className="absolute inline-block w-36 h-36 rounded-full border border-neutral-200 animate-ping opacity-10" />
        <span className="absolute inline-block w-28 h-28 rounded-full bg-neutral-50 animate-ping opacity-20" />
        <span className="relative flex items-center justify-center w-24 h-24 rounded-full bg-white border border-neutral-100 shadow-[0_8px_32px_rgba(0,0,0,0.08)]">
          <CheckCircle size={52} strokeWidth={1.4} className="text-black" />
        </span>
      </div>
      ...
      {/* Order info card */}
      <div className="w-full max-w-sm border border-neutral-100 bg-neutral-50 p-6 mb-8 text-left space-y-4 shadow-[0_2px_16px_rgba(0,0,0,0.04)]">
        {/* Order number */}
