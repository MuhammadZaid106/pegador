...
const Header = () => {
  ...
  const useLightTheme = isScrolled || activeMenu !== null || isMobileMenuOpen;
    ...
    >
      <div className="mx-auto flex w-full max-w-screen-2xl items-center justify-between relative h-12">
        ...
        <div className="pointer-events-none absolute left-1/2 -translate-x-1/2">
          <Link href="/" className="pointer-events-auto block w-32 sm:w-48 lg:w-64">
            <img
        ...
        <div className="flex items-center gap-3.5 sm:gap-5">
          ...
          >
            <ShoppingBag size={24} strokeWidth={1.6} className="cursor-pointer" />
          </button>
        </div>
      </div>
        ...
        <div className="fixed inset-0 top-[60px] z-40 bg-white overflow-y-auto px-6 py-8 flex flex-col lg:hidden border-t border-neutral-100 h-[calc(100vh-60px)]">
          <div className="flex flex-col space-y-4">
            {navLinks.map((link) => {
              ...
              return (
                <div key={link.label} className="border-b border-neutral-100 pb-3">
          ...
          <div className="mt-auto pt-10 flex flex-col gap-4 text-center pb-10">
            <Link
              href="/login"
              onClick={() => setIsMobileMenuOpen(false)}
              className="text-[12px] text-neutral-700 font-bold tracking-[0.15em] uppercase hover:underline"
            >
              My Account
            </Link>
